...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="index-2.html"><img src="https://www.urbanui.com/polluxui/template/images/logo.svg" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href="index-2.html"><img src="https://www.urbanui.com/polluxui/template/images/logo-mini.svg" alt="logo"/></a>
    ...
    <!-- partial -->
    <nav class="navbar-breadcrumb col-lg-12 col-12 d-flex flex-row p-0">
                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      ...
                      <h4>1352</h4>
                      <canvas id="transactions-chart-dark" class="mt-auto" height="65"></canvas>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      ...
                      <canvas id="sales-chart-a-dark" class="mt-auto" height="65"></canvas>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6 stretch-card grid-margin grid-margin-md-0">
                  <div class="card">
                    <div class="card-body d-flex flex-column justify-content-between">
                      ...
                      <canvas id="sales-chart-b-dark" class="mt-auto" height="38"></canvas>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-start flex-wrap">
                        ...
                        <div id="income-chart-dark-legend" class="d-flex flex-wrap mt-1 mt-md-0"></div>
                      </div>
                      <canvas id="income-chart-dark"></canvas>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <canvas id="expense-chart-dark" height="80"></canvas>
                </div>
              </div>
            </div>
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <canvas id="budget-chart-dark" height="80"></canvas>
                </div>
              </div>
            </div>
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <canvas id="balance-chart-dark" height="80"></canvas>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2018 <a href="https://www.urbanui.com/" class="text-muted" target="_blank">Urbanui</a>. All rights reserved.</span>
...
<!-- Mirrored from www.urbanui.com/polluxui/template/demo/vertical-default-dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Apr 2020 17:50:05 GMT -->
</html>
